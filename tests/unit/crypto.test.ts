...
describe('Crypto', () => {
  ...
  describe('validateIntegrity', () => {
    ...
    it('should return false with tampered ciphertext', async () => {
      ...
      expect(crypto.validateIntegrity(envelope)).toBe(true); // structural check passes (fields present)
      // Decryption must throw due to auth tag mismatch (tampered ciphertext)
