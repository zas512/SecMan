...
exports.SecManCLI = void 0;
const commander_1 = require("commander");
const core_1 = require("@secman/core");
class SecManCLI {
    constructor(projectRoot) {
        this.core = new core_1.Core(projectRoot);
    ...
    setupCommands() {
        ...
        this.program
            ...
            if (options.list) {
                ...
                console.log('env delete not yet implemented');
            }
            else if (options.use) {
                console.log('env use not yet implemented');
            }
            else {
